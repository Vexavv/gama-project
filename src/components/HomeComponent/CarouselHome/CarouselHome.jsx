...
function CarouselHome(props) {
    const CustomArrow = ({ onClick, className, icon }) => {
        return (
            <div className={`${styles.customArrow} ${className}`} onClick={onClick}>
        ...
        <div className={styles.carousel}>
            <Container>
                ...
                <Carousel
                    ...
                    customPrev={<CustomArrow className="customArrowLeft" icon={<FiChevronLeft />} />}
                    customNext={<CustomArrow className="customArrowRight" icon={<FiChevronRight />} />}
